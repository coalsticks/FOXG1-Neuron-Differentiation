...
sample_11DIV <- sample_meta |> # Here we take the names for the samples at 31 DIV
...
raw_count_11 <- raw_count[, unlist(sample_11DIV)] # Here the gene expression values corresponding to samples at 11 DIV
...
# Now I need to put this into the dataset!!!
